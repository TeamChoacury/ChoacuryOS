# Contributing to ChoacuryOS

First off, thank you for taking the time to contribute to the project! ❤️
...
> If you want to ask a question, we assume that you have read the available [Documentation](https://teamchoacury.github.io/docs).
...
- Provide as many details as you can about the issue you are facing.
- Add steps to reproduce if you can.

We will look at the issue.

If it is not an issue, we suggest opening a discussion on the [discussions tab](/discussions)
...
- Determine if your bug is really a bug and not an error on your side (e.g. using incompatible environment components/versions - make sure that you have read the [documentation](https://teamchoacury.github.io/docs/)).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://teamchoacury.github.io/docs/) carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project.
  It's up to you to make a strong case to convince the project's developers of the merits of this feature.
  Keep in mind that we want features that will be useful to the majority of our users and not just a small subset.
  If you're just targeting a minority of users, consider writing a package that they can install.
...
If this is your first time contributing to the project, make sure that you read through the various documentation, and other contributions, to familiarise yourself with the projects and our style.
